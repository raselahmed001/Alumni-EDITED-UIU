		...
		if ( $.isPlainObject( val ) ) {
			...
			if ( _ieExcel ) {
				...
				if ( str.indexOf( '<?xml' ) === -1 ) {
					str = '<?xml version="1.0" encoding="UTF-8" standalone="yes"/* DEVELOPED BY STUDENTPROJECTGUIDE.COM */  ?>'+str;
				}
...
var excelStrings = {
	"_rels/.rels":
		'<?xml version="1.0" encoding="UTF-8" standalone="yes"/* DEVELOPED BY STUDENTPROJECTGUIDE.COM */  ?>'+
	...
	"xl/styles.xml": 
		'<?xml version="1.0" encoding="UTF-8"/* DEVELOPED BY STUDENTPROJECTGUIDE.COM */  ?>'+
